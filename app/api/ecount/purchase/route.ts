...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📥 구매 요청 수신:', { product, productCode, quantity, price, vendor });
    ...
    console.log('📤 이카운트 API 전송 데이터:', JSON.stringify(purchaseData, null, 2));
    ...
    const ecountUrl = `https://sboapi${zone}.ecount.com/OAPI/V2/Purchases/SavePurchases?SESSION_ID=${sessionId}`;
